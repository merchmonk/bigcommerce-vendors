...
-- RenameIndex
ALTER INDEX "endpoint_mappings_standard_type_endpoint_name_endpoint_version_" RENAME TO "endpoint_mappings_standard_type_endpoint_name_endpoint_vers_key";

-- RenameIndex
ALTER INDEX "pending_related_product_links_vendor_id_source_vendor_product_i" RENAME TO "pending_related_product_links_vendor_id_source_vendor_produ_key";

-- RenameIndex
ALTER INDEX "product_enrichment_retries_vendor_id_vendor_product_id_source_k" RENAME TO "product_enrichment_retries_vendor_id_vendor_product_id_sour_key";
